...
foreach(_expectedTarget LLVMHello LLVMTestingSupport FileCheck llvm-PerfectShuffle count not yaml-bench BugpointPasses lli-child-target llvm-jitlink-executor obj2yaml yaml2obj Bye TestPlugin gtest gtest_main)
...
set_target_properties(gtest PROPERTIES
  ...
  INTERFACE_INCLUDE_DIRECTORIES "/mnt/DataLinux/diploma/llvm-project/llvm/utils/unittest/googletest/include;/mnt/DataLinux/diploma/llvm-project/llvm/utils/unittest/googlemock/include"
...
set_target_properties(LLVMHello PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "/mnt/DataLinux/diploma/llvm-project/llvm/cmake-build-debug/lib/LLVMHello.so"
...
set_target_properties(LLVMTestingSupport PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "/mnt/DataLinux/diploma/llvm-project/llvm/cmake-build-debug/lib/libLLVMTestingSupport.a"
  )
...
set_target_properties(FileCheck PROPERTIES
  IMPORTED_LOCATION_DEBUG "/mnt/DataLinux/diploma/llvm-project/llvm/cmake-build-debug/bin/FileCheck"
  )
...
set_target_properties(llvm-PerfectShuffle PROPERTIES
  IMPORTED_LOCATION_DEBUG "/mnt/DataLinux/diploma/llvm-project/llvm/cmake-build-debug/bin/llvm-PerfectShuffle"
  )
...
set_target_properties(count PROPERTIES
  IMPORTED_LOCATION_DEBUG "/mnt/DataLinux/diploma/llvm-project/llvm/cmake-build-debug/bin/count"
  )
...
set_target_properties(not PROPERTIES
  IMPORTED_LOCATION_DEBUG "/mnt/DataLinux/diploma/llvm-project/llvm/cmake-build-debug/bin/not"
  )
...
set_target_properties(yaml-bench PROPERTIES
  IMPORTED_LOCATION_DEBUG "/mnt/DataLinux/diploma/llvm-project/llvm/cmake-build-debug/bin/yaml-bench"
  )
...
set_target_properties(BugpointPasses PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_DEBUG ""
  IMPORTED_LOCATION_DEBUG "/mnt/DataLinux/diploma/llvm-project/llvm/cmake-build-debug/lib/BugpointPasses.so"
  IMPORTED_NO_SONAME_DEBUG "TRUE"
  )
...
set_target_properties(lli-child-target PROPERTIES
  IMPORTED_LOCATION_DEBUG "/mnt/DataLinux/diploma/llvm-project/llvm/cmake-build-debug/bin/lli-child-target"
  )
...
set_target_properties(llvm-jitlink-executor PROPERTIES
  IMPORTED_LOCATION_DEBUG "/mnt/DataLinux/diploma/llvm-project/llvm/cmake-build-debug/bin/llvm-jitlink-executor"
  )
...
set_target_properties(obj2yaml PROPERTIES
  IMPORTED_LOCATION_DEBUG "/mnt/DataLinux/diploma/llvm-project/llvm/cmake-build-debug/bin/obj2yaml"
  )
...
set_target_properties(yaml2obj PROPERTIES
  IMPORTED_LOCATION_DEBUG "/mnt/DataLinux/diploma/llvm-project/llvm/cmake-build-debug/bin/yaml2obj"
  )
...
set_target_properties(Bye PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_DEBUG ""
  IMPORTED_LOCATION_DEBUG "/mnt/DataLinux/diploma/llvm-project/llvm/cmake-build-debug/lib/Bye.so"
  IMPORTED_NO_SONAME_DEBUG "TRUE"
  )
...
set_target_properties(TestPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_DEBUG ""
  IMPORTED_LOCATION_DEBUG "/mnt/DataLinux/diploma/llvm-project/llvm/cmake-build-debug/unittests/Passes/TestPlugin.so"
  IMPORTED_NO_SONAME_DEBUG "TRUE"
  )
...
set_target_properties(gtest PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "/mnt/DataLinux/diploma/llvm-project/llvm/cmake-build-debug/lib/libgtest.a"
  )
...
set_target_properties(gtest_main PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "/mnt/DataLinux/diploma/llvm-project/llvm/cmake-build-debug/lib/libgtest_main.a"
  )
